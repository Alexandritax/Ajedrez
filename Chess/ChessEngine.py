...
class GameState():
    ...
    def get_valid_moves(self):
        ...
        print("is my king exposed {in_check}\nis there a piece pinned {pins}\nis my king checked {checks}".format(in_check=self.in_check,pins=self.pins,checks=self.checks))
        ...
        if self.in_check:
            if len(self.checks) == 1:
                ...
                if piece_checking[1] == 'N':
                    ...
                    for i in range(1,8):
                        valid_square = (king_row + check[2] * i, king_col + check[3] * i) #check 2 and 3 are the directions
